 ...
 * @LastEditTime: 2021-06-26 14:14:46
 * @LastEditors: dylan
 * @Description: a more perfect echo-client(better than ch4/echo_client.c)
 * @FilePath: /TCPIP_NetworkProgramming/ch5/echo_client2.c
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
